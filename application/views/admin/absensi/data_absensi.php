						...
						<div class="card-body">
							...
							<div class="table-responsive">
								<table class="table table-striped" id="dataTable" width="100%" cellspacing="0">
									<thead class="thead-dark">
										<tr>
											...
											<td class="text-center">Jenis Kalamin</td>
								...
								<div class="d-flex justify-content-end">
									<a href="<?php echo site_url('admin/data_absensi/update_absensi/'. $bulantahun) ?>" type="button" class="btn btn-warning">Edit Data</a>
								</div>
							</div>
						</div>
					</div>
